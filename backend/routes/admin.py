...
# ============================================================
# DECORADOR (Correcto y funcional)
# ============================================================
...
@admin_required
def handle_users(current_admin_id):
...
@admin_required
def handle_ac_models(current_admin_id):
    if request.method == 'GET':
...
@admin_bp.route('/inference-engines', methods=['GET', 'POST'])
@admin_required
def handle_inference_engines(current_admin_id):
    if request.method == 'GET':
...
@admin_required
def handle_settings(current_admin_id):
